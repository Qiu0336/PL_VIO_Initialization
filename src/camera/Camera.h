...
public:
    ...
    // Lift points from the image plane to the projective space and reproject to image plane
    virtual void liftReprojective(const Eigen::Vector2d& p, Eigen::Vector2d& P) const = 0;
    //%output P
