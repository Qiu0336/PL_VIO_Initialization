...
public:
    ...
    bool ConstructInitial(int frame_num, Quaterniond* q, Vector3d* T, int l,
                  const Matrix3d relative_R, const Vector3d relative_T,
                  vector<SFMFeature> &sfm_f, map<int, Vector3d> &sfm_tracked_points);
    bool ConstructIncreasing(int frame_num, Quaterniond* q, Vector3d* T, int l,
                  const Matrix3d relative_R, const Vector3d relative_T,
                  vector<SFMFeature> &sfm_f, map<int, Vector3d> &sfm_tracked_points,
...
private:
    ...
    int triangulateTwoFrames(int frame0, Eigen::Matrix<double, 3, 4> &Pose0,
