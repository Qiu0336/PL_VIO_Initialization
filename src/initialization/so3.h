...
inline Eigen::Matrix3d LeftJacobianSO3(const Eigen::Vector3d &v) { return LeftJacobianSO3(v[0], v[1], v[2]); }
...
inline Eigen::Matrix3d InverseLeftJacobianSO3(const Eigen::Vector3d &v) { return InverseLeftJacobianSO3(v[0], v[1], v[2]); }
